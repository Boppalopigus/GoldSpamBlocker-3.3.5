...
GSB_Patterns = GSB_Patterns or {
    ...
    ---------- German (deDE) ----------
    -- gold kaufen = buy gold, billiges gold = cheap gold
    -- powerleveling, konto zu verkaufen = account for sale
    "gold kaufen",
    "billiges gold",
    "gold verkaufen",
    "gold.?shop",
    "wow.?gold kaufen",
    "sofortige lieferung",   -- instant delivery
    "konto zu verkaufen",
    "account verkaufen",
    "powerleveling",         -- same word in German

    ---------- French (frFR) ----------
    -- acheter de l'or = buy gold, or pas cher = cheap gold
    -- vendre or = sell gold, livraison rapide = fast delivery
    "acheter.+or",
    "or pas cher",
    "vendre.+or",
    "or wow",
    ...
    "compte.*vendre",
    "vendre.*compte",
    "powerleveling",         -- same word in French

    ---------- Spanish (esES / esMX) ----------
    -- comprar oro = buy gold, oro barato = cheap gold
    -- vender oro = sell gold, entrega rapida = fast delivery
    "comprar oro",
    "oro barato",
    "vender oro",
    "oro wow",
    ...
    "cuenta.*venta",
    "venta.*cuenta",
    "subida de nivel",       -- powerleveling

    ---------- Portuguese (ptBR / ptPT) ----------
    -- comprar ouro = buy gold, ouro barato = cheap gold
    -- vender ouro = sell gold, entrega rapida = fast delivery
    "comprar ouro",
    "ouro barato",
    "vender ouro",
    "ouro wow",
    ...
    "conta.*venda",
    "venda.*conta",
    "leveling de personagem",

    ---------- Korean (koKR) ----------
    -- 골드 구매 = buy gold, 저렴한 골드 = cheap gold
    -- 골드 판매 = sell gold, 빠른 배송 = fast delivery
    -- 계정 판매 = account for sale, 대리 육성 = powerleveling
    "골드 구매",
    "저렴한 골드",
    "골드 판매",
    "골드 싸게",
